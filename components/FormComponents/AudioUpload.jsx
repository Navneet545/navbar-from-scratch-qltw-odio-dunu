...
export default function AudioUpload({ label, name, value, onChange, error, accept = "audio/*" }) {
  ...
  return (
    <div className="flex flex-col">
      ...
      {/* File Info & Controls - Always visible but compact */}
      {value && (
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-1 ml-2">
              <button
                ...
                className="px-2 py-1 text-xs bg-[var(--color-secondary)] text-white rounded hover:bg-[var(--color-secondar-hover)]"
              >
